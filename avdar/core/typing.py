"""
Borrowed from https://github.com/threestudio-project/threestudio/blob/main/threestudio/utils/typing.py
...
# PyTorch Tensor type
from torch import Tensor, FloatTensor, IntTensor, BoolTensor, LongTensor
